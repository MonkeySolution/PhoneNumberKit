...
public final class PartialFormatter {
    ...
    private let phoneNumberKit: LibPhoneNumberKit

    weak var metadataManager: MetadataManager?
    weak var parser: PhoneNumberParser?
    weak var regexManager: RegexManager?

    public convenience init(phoneNumberKit: LibPhoneNumberKit = LibPhoneNumberKit(), defaultRegion: String = LibPhoneNumberKit.defaultRegionCode(), withPrefix: Bool = true, maxDigits: Int? = nil) {
    ...
    init(phoneNumberKit: LibPhoneNumberKit, regexManager: RegexManager, metadataManager: MetadataManager, parser: PhoneNumberParser, defaultRegion: String, withPrefix: Bool = true, maxDigits: Int? = nil) {
