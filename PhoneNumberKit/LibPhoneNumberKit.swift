...
public final class LibPhoneNumberKit: NSObject {
    ...
    // MARK: Lifecycle
    public init(metadataCallback: @escaping MetadataCallback = LibPhoneNumberKit.defaultMetadataCallback) {
    ...
    public func parse(_ numberString: String, withRegion region: String = LibPhoneNumberKit.defaultRegionCode(), ignoreType: Bool = false) throws -> PhoneNumber {
    ...
    public func parse(_ numberStrings: [String], withRegion region: String = LibPhoneNumberKit.defaultRegionCode(), ignoreType: Bool = false, shouldReturnFailedEmptyNumbers: Bool = false) -> [PhoneNumber] {
    ...
    public static func defaultMetadataCallback() throws -> Data? {
        let frameworkBundle = Bundle(for: LibPhoneNumberKit.self)
